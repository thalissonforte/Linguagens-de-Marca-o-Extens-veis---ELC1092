...
<xsl:output method="html" omit-xml-declaration="no" encoding="iso-8859-1" indent="yes" standalone="yes"/>
	<xsl:template match="/">		
			<xsl:result-document href="src/processos.html">
				<html>
					<head>
					...
					<body>
						...
						<div class="container">
							<br/><h1>Processos</h1>
							<p class="lead">Ordenados por ID</p>

                                <div class="my-3 p-3 bg-white rounded box-shadow">
                                    <div class="media text-muted pt-3">
                                        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                                            <div class="d-flex justify-content-between align-items-center w-100">
                                                <strong class="text-gray-dark">ID - Emigrante vinculado</strong>
                                            </div>
                                        </div>
                                        ...
                                        <xsl:for-each select="Museu/Processo">
                                            ...
                                            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                                                <span class="d-block">
                                                    <a href="./../src/processos/Processo-{numCM}.html">
                                                        <xsl:value-of select="numCM"/> - <xsl:value-of select="../IdentificacaoEmigrante[idEmigrante=$id_emigrante]/nome"/>
                                                        <!--../IdentificacaoEmigrante[idEmigrante=$id_emigrante]/nome-->
                                                    </a>
                                                </span>
                                            </div>
                                        </xsl:for-each>
